...
<div class="row">
	<div class="col-md-12">
		...
		<?php $this->startBoxPrimary(getMLText("nonconfo_add_actions")); ?>

		<form action='../op/op.AddAction.php' id='form1' name='form1' method='post'>
			...
			<input type='hidden' name='nonconfoId' value='<?php echo $nonconfoId; ?>'/>
				...
				<div class="form-group">
					<label><?php echo getMLText('nonconfo_action_date_start');?>:</label>
		      		...
		      		<input class="form-control" name="start" type="text" value="<?php echo $expdate; ?>">
				...
				<div class="form-group">
					...
					<div>
		      		...
		      		<input class="form-control" name="end" type="text" value="<?php echo $expdate; ?>">
		      		<span class="add-on"><i class="icon-calendar"></i></span>
		    		</span>
					</div>
				</div>
