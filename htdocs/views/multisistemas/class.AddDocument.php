...
?>
		...
		<tr>
			<td class="lbl-right"><?php printMLText("comment");?>:</td>
			<td><textarea name="comment" rows="3" cols="80"<?php echo $strictformcheck ? ' required' : ''; ?>></textarea></td>
		</tr>
		<tr>
			<td class="lbl-right"><?php printMLText("keywords");?>:</td>
			<td><?php $this->printKeywordChooserHtml("form1");?></td>
		</tr>
		<tr>
			<td class="lbl-right"><?php printMLText("categories")?>:</td>
			<td>
...
<?php
			...
			if($attrdefs) {
				foreach($attrdefs as $attrdef) {
					...
					if(is_array($arr)) {
						echo "<tr>";
						echo "<td class='lbl-right'>".$arr[0].":</td>";
						echo "<td>".$arr[1]."</td>";
						echo "</tr>";
					} else {
?>
...
?>
		<tr>
			<td class="lbl-right"><?php printMLText("expires");?>:</td>
			<td>
		...
		<tr>
			<td class="lbl-right"><?php printMLText("local_file");?>:</td>
			<td>
<!--
...
?>
		<tr>	
      <td>
			<div class="cbSelectTitle lbl-right"><?php printMLText("workflow");?>:</div>
      </td>
      <td>
<?php
